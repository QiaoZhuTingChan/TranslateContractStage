...
public class Environment {
	...
	// 第三方百融
	public static final String BAIRONG_HTML_PHYSICSPATH = "baiRongHtmlPhysicsPath";
	public static final String BAIRONG_HTML_RELATIVEPATH = "baiRongHtmlRelativePath";
	public static final String BAIRONG_USERNAME = "baiRongUserName";
	public static final String BAIRONG_PWD = "baiRongPwd";
	public static final String BAIRONG_APICODE = "baiRongApiCode";
	...
	public static final String WEB_SOCKET_SERVICE_URL = "webSocketServiceUrl";

	// 还款类型为先息后本且还款期限小于此值的合同可续期
	public static final String STAGE_NUM = "stageNum";

	public static final String LATEFEE_DAY = "late_fee_day";// 还款可以清理逾期天数
	...
	public static Integer getLateFeeDay() {
		String result = "";
		try {
			result = CONFIGURATION.getString(LATEFEE_DAY);
		} catch (Exception e) {
			Messagebox.info("当前逾期天数參數没有拿到!");
		}
	...
	public static String getWebPath() {
		String str = "";
		try {
			str = CONFIGURATION.getString(HTTP_URL);
		} catch (Exception e) {
			Messagebox.info(HTTP_URL);
		}
		return str;
	}
	 ...
	 * 第三方百融 5个
	 */
	public static String getBaiRongApiCode() {
		String str = "";
		try {
			str = CONFIGURATION.getString(BAIRONG_APICODE);
		} catch (Exception e) {
			log.error("找不到参数:baiRongApiCode", e);
		}
		return str;
	}

	public static String getBaiRongPwd() {
		String str = "";
		try {
			str = CONFIGURATION.getString(BAIRONG_PWD);
		} catch (Exception e) {
			log.error("找不到参数:baiRongPwd", e);
		}
		return str;
	}

	public static String getBaiRongUserName() {
		String str = "";
		try {
			str = CONFIGURATION.getString(BAIRONG_USERNAME);
		} catch (Exception e) {
			log.error("找不到参数:baiRongUserName", e);
		}
		return str;
	}

	public static String getBaiRongHtmlRelativePath() {
		String str = "";
		try {
			str = CONFIGURATION.getString(BAIRONG_HTML_RELATIVEPATH);
		} catch (Exception e) {
			log.error("找不到参数:baiRongHtmlRelativePath", e);
		}
		return str;
	}

	public static String getBaiRongHtmlPhysicsPath() {
		String str = "";
		try {
			str = CONFIGURATION.getString(BAIRONG_HTML_PHYSICSPATH);
		} catch (Exception e) {
			log.error("找不到参数:baiRongHtmlPhysicsPath", e);
		}
		return str;
	}
	...
	/**
	 * 获取WebSocket服务访问地址，通过此地址发送消息给WebSocket服务器
	 * 
	 * @return
	 */
	public static String getWebSocketServiceUrl() {
		...
		try {
			webSocketServiceUrl = CONFIGURATION.getString(WEB_SOCKET_SERVICE_URL);
		} catch (Exception e) {
			log.error("找不到参数:webSocketServiceUrl", e);
		}
	...
	public static int getStageNum() {
		int StageNum = 0;
		try {
			StageNum = CONFIGURATION.getInt(STAGE_NUM);
		} catch (Exception e) {
			log.error("找不到参数:stageNum", e);
		}
		return StageNum;
	}
}
