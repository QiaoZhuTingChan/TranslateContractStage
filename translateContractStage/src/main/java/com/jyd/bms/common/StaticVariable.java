...
public class StaticVariable {
	...
	// 作业模块类型
	// 查询所有
	public final static int JOB_PLEASE_SELECT = 0;
	// 月结
	public final static int JOB_MONTHLY_STATEMENT = 1;
	// 周结
	public final static int JOB_WEEKS_STATEMENT = 2;
	// 逾期
	public final static int JOB_LATE_FEE = 3;
	// 第三方gps
	public final static int JOB_GPS = 4;
	// 分期与逾期邮件
	public final static int JOB_LATE_STAGE_EMAIL = 5;
	// 工作流的记录
	public final static int JOB_RECORD_PERSON = 6;
	...
	public static final String GRAY_COLOR = "#150517";
	...
	// 还款状态
	public static Map<Integer, String> getRepayemtState() {
	...
	// 还款状态
		public static Map<Integer, String> getFundRepayemtState() {
			Map<Integer, String> map = new HashMap<Integer, String>();
			map.put(0, "本金");
			map.put(1, "利息");
		/*	map.put(2, "利息");
